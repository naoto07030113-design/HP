      ...
      <div className="relative w-full max-w-sm animate-fade-up">
        <div className="flex flex-col items-center mb-8">
          <div className="w-14 h-14 rounded-2xl bg-gradient-to-br from-green-700 to-green-900 ring-1 ring-gold-400/50 shadow-lg flex items-center justify-center mb-4">
            <Wallet className="w-6 h-6 text-gold-200" />
          </div>
          <p className="font-bold text-white text-lg tracking-wide">経費・出納帳</p>
          <p className="text-[11px] text-gold-300/70 tracking-[0.3em] mt-1">EXPENSE &amp; CASHBOOK</p>
        </div>

        <div className="bg-white rounded-3xl shadow-lg p-7">
          <h1 className="text-lg font-bold text-green-950 mb-1">ログイン</h1>
