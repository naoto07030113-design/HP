...
export const CLINIC_URL = process.env.NEXT_PUBLIC_CLINIC_SUPABASE_URL || 'https://fupfwpyvejzwrubomhov.supabase.co'
export const CLINIC_ANON_KEY = process.env.NEXT_PUBLIC_CLINIC_SUPABASE_ANON_KEY || 'sb_publishable_jIbUWn3vDXHZtGF_DJ8a1A_kpMt-NcE'
